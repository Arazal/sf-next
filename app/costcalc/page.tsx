...
useEffect(() => {
  ...
  fetchData();
    ...
    <div className='container md:w-1/2 mx-auto m-3'>
        ...
        <div className=' columns-1 text-center text-xl'>
    ...
    <form onSubmit={handleSubmit} className="container mx-auto space-y-6 rounded-md border-2 border-purple-600 bg-white p-4 text-purple-950 shadow-md">
