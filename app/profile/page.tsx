...
export default function Profile() {
    return (
        ...
        <section>
       <h3 className=' m-1 text-center'>COMPANY PROFILE</h3>
       <h4 className='m-1 text-center'>SF (Stock code: 002352) was established in Shunde, Guangdong Province in 1993.</h4>
            <h4 className='m-1'>SF is the largest integrated logistics service provider in China, and the fourth largest express delivery enterprise in the world, providing domestic and international end-to-end one-stop supply chain services. At the same time, relying on leading scientific and technological research and development capabilities, SF is committed to building the digital supply chain ecology and becoming a leader in the global intelligent supply chain.</h4>
        ...
        <br />
        <section>
            <h2 className='text-center'>Industry-leading <span className='text-sfsecondary'>Service and Brand Value</span></h2>
            <h4 className='text-center m-1'>After years of dedicated operation, SF has earned considerable reputation and popularity in the industry, and has established the “rapid, punctual and safe” brand image.
